				...
				<div class="container">
					...
					<div class="sub">
						...
						<p>
							...
							αλλά η εμπλοκή της Ελλάδας σε έναν πόλεμο με την Αυστροουγγαρία ενείχε μεγάλους κινδύνους, εκτιμούσε ο Κωνσταντίνος Α΄. Για τον Βενιζέλο προείχε η σωτηρία της Θεσσαλονίκης στο πεδίο της μάχης.
						</p>
						<br>
						<figure>
					...
					<div class="text">
						<p>
							&nbsp;&nbsp;&nbsp;&nbsp; Μια εμπλοκή της Αυστροουγγαρίας εναντίον της Σερβίας, καθώς είχαν ήδη συγκροτηθεί οι συνασπισμοί της Αντάντ και των Κεντρικών Δυνάμεων, φαινόταν απίθανη, 
